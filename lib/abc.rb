...
module Abc
  ...
  class << self
    ...
    def to_png(notation)
      ...
      return ps_to_png #requires Out.ps and out.png to 'exist' or be creatable respectively.
    end
    ...
    def ps_to_png
      ...
      #CONVERT TO PNG COMMAND ==> gs -dSAFER -dBATCH -dNOPAUSE -sDEVICE=png16m -dGraphicsAlphaBits=4 -sOutputFile=out%d.png Out.ps
